...
@Component({
  selector: 'app-investigatioin',
  templateUrl: './investigatioin.component.html',
  styleUrls: ['./investigatioin.component.css']
})
export class InvestigatioinComponent implements OnInit {
