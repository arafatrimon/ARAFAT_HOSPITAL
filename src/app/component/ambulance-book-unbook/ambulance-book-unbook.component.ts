...
@Component({
  selector: 'app-ambulance-book-unbook',
  templateUrl: './ambulance-book-unbook.component.html',
  styleUrls: ['./ambulance-book-unbook.component.css']
})
export class AmbulanceBookUnbookComponent implements OnInit {
